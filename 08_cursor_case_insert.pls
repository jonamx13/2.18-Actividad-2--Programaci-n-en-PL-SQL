--8
--Uso de la instrucción CASE para insertar empleados según su departamento
...
BEGIN
    FOR reg_emp IN cemp LOOP
        ...
        dbms_output.put_line('Registro insertado... ' ||
            reg_emp.employee_id || ' ' || reg_emp.first_name || ' ' ||
